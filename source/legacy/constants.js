...
let all_constants = {
        ...
        drawer_item: {
            ...
            orders_history: {
                ...
                status: {
                    ...
                    processing: "Acceptée le ",
                    cancelled_by_customer: "Annulée le ",
                    cancelled_by_cooker: "Refusée le ",
                    completed: "Prête le ",
                },
                original_status: {
    ...
    search_modal: {
        ...
        order_date_filter: {
            delivered: "Livrées",
            cancelled_by_customer: "Annulées par vous",
            cancelled_by_cooker: "Annulées par le cuisinier",
        },
        ...
        state_order: "Etat de la commande",
        cancel: "Annuler",
